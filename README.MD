...
The graphical interface is click operated; Keyboard functionality has broken sometime since the code was last majorly updated in 2010. 

Launch it by going to the directory and running:
	$java engine
